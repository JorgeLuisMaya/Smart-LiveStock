                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'k8fwp9vs' /* Let's get started by filling o... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'n0tbq2rh' /* Already have an account? */,
                                          ),
                                          style: TextStyle(),
                                        ),
                                        TextSpan(
